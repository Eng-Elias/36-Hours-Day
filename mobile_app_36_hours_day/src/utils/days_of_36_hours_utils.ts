...
export default class DaysOf35HoursUtils {
  ...
  static startHourStorageKey = 'StartHourIn36HoursDay';

  static async storeStartHourInStorage(startHour: number) {
    StorageUtils.setItem(DaysOf35HoursUtils.startHourStorageKey, startHour);
  }

  static getStartHourFromStorage() {
